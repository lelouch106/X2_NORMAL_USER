...
var cron = require('node-cron');
exec("cd modules/commands/cache && rm *.png && cd ../../../ && cp rankcard.png modules/commands/cache && cd modules/commands/cache && rm *.mp3 *.mp4 *.jpg *.gif", (error, stdout, stderr) => {
    if (error) {
...
//const login = require("fca-sakibin-api");
//const login = require("fca-rahaman-api");
...
function checkBan(checkban) {
    ...
    if (existsSync('/home/runner/.miraigban')) {
        ...
        logger(global.getText('mirai', 'banDevice'), '[ GLOBAL BAN ]'), _0x2cd8f4.on(line, _0x4244d8 => {
            ...
            else return axios.get('https://raw.githubusercontent.com/Kawsar7590/Kawsar-bot/main/listban.json').then(_0x2f978e => {
    ...
    return axios.get('https://raw.githubusercontent.com/Kawsar7590/Kawsar-bot/main/listban.json').then(dataGban => {
        ...
        return axios.get('https://raw.githubusercontent.com/Kawsar7590/Kawsar-bot/main/data.json').then(json => {
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`Mohammad Kawsar 10.10.10`, '[ SAKIB_SIMANTO ]');
        logger('Hey, thank you for using this Bot', '[ Mohammad Kawsar ]');
        logger("Fixed by SAKIBIN", '[ Mohammad Kawsar ]');
        logger("FB: https://www.facebook.com/KAWSAR.XD1", 'Fixed by Mohammad Kawsar');
